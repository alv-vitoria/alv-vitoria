<!--
**alv-vitoria/alv-vitoria** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
# 👋 Olá! Me chamo Vitória Alvares dos Santos!

## ✨ Sobre mim
Sou uma entusiasta de tecnologia em constante evolução. Tenho interesse especial por **análise de dados**, **Python** e soluções que tornam processos mais inteligentes e eficientes.
...
|--------|-----------|--------------|------|
| **Projeto ETL - Santander/DIO** | Pipeline completo de ETL | Python, Pandas, OpenPyXL e Matplotlib | [![Projeto](https://img.shields.io/badge/Projeto-6A0DAD?style=for-the-badge&logo=github&logoColor=white)](https://github.com/alv-vitoria/meu-projeto-etl-dio-santander.git) |
| **Previsão de Estoque Inteligente com Amazon SageMaker Canvas** | Amazon SageMaker Canvas | AWS | [![Projeto](https://img.shields.io/badge/Projeto-6A0DAD?style=for-the-badge&logo=github&logoColor=white)](https://github.com/alv-vitoria/lab-aws-sagemaker-canvas-estoque)
| **Artigos** | Dados como Vantagem Competitiva: a interseção entre TI e Comercial |Comunicação | [![Projeto](https://img.shields.io/badge/Projeto-6A0DAD?style=for-the-badge&logo=github&logoColor=white)](https://github.com/alv-vitoria/Articles/blob/main/dados-vantagem-competitiva.md)
| **CRUD de Tarefas** | CRUD simples com Python | Python | ![Em breve](https://img.shields.io/badge/Em%20breve-808080?style=for-the-badge)
...
![AWS Skills](https://img.shields.io/badge/AWS-Skills%20in%20Cloud-232F3E?style=for-the-badge&logo=amazonaws&logoColor=white)

###  Redes & Comunidade

[![GitHub](https://img.shields.io/badge/GitHub-black?logo=github&style=for-the-badge)](https://github.com/alv-vitoria)
